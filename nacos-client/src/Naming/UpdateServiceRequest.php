...
use Nacosvel\NacosClient\Contracts\V1\Naming\UpdateServiceInterface as V1;
use Nacosvel\NacosClient\Contracts\V2\Naming\UpdateServiceInterface as V2;
use Nacosvel\NacosClient\NacosRequestResponse;

class UpdateServiceRequest extends NacosRequestResponse implements V1, V2
{
    /**
     * Request Method
     *
    ...
    public function v1(string $serviceName, float $protectThreshold = 0): V1
    {
        return new class($serviceName, $protectThreshold, 'v1') extends UpdateServiceRequest implements V1, V2 {
            public function __construct(string $serviceName, float $protectThreshold = 0, string $version = null)
            {
                parent::__construct($version);
                $this->method = self::PUT;
                $this->setServiceName($serviceName)->setProtectThreshold($protectThreshold);
            }
    ...
    {
        return new class($serviceName, 'v2') extends UpdateServiceRequest implements V1, V2 {
