...
use Nacosvel\NacosClient\Contracts\V1\Naming\UpdateInstanceMetadataBatchInterface as V1;
use Nacosvel\NacosClient\Contracts\V2\Naming\UpdateInstanceMetadataBatchInterface as V2;
use Nacosvel\NacosClient\NacosRequestResponse;

class UpdateInstanceMetadataBatchRequest extends NacosRequestResponse implements V1, V2
{
    /**
     * Request Method
     *
    ...
    {
        return new class($namespaceId, $serviceName, $metadata, 'v1') extends UpdateInstanceMetadataBatchRequest implements V1, V2 {
    ...
    {
        return new class($serviceName, $metadata, 'v2') extends UpdateInstanceMetadataBatchRequest implements V1, V2 {
