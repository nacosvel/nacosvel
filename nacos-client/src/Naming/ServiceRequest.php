...
use Nacosvel\NacosClient\Contracts\V1\Naming\ServiceInterface as V1;
use Nacosvel\NacosClient\Contracts\V2\Naming\ServiceInterface as V2;
use Nacosvel\NacosClient\NacosRequestResponse;

class ServiceRequest extends NacosRequestResponse implements V1, V2
{
    /**
     * Request Method
     *
    ...
    {
        return new class($serviceName, 'v1') extends ServiceRequest implements V1, V2 {
    ...
    {
        return new class($serviceName, 'v2') extends ServiceRequest implements V1, V2 {
            public function __construct(string $serviceName, string $version = null)
            {
                parent::__construct($version);
                $this->setServiceName($serviceName);
