...
if (!function_exists('Nacosvel\Helpers\Utils\http_parse_query')) {
    /**
...
if (!function_exists('Nacosvel\Helpers\Utils\\array_some')) {
    /**
...
if (!function_exists('Nacosvel\Helpers\Utils\\array_every')) {
    /**
...
if (!function_exists('Nacosvel\Helpers\Utils\\array_replicate')) {
    /**
