...
use Nacosvel\NacosClient\Contracts\Naming\ClientServersPublishListInterface;
use Nacosvel\NacosClient\NacosRequestResponse;

class ClientServersPublishListRequest extends NacosRequestResponse implements ClientServersPublishListInterface
{
    /**
     * Request Method
     *
     ...
     * @var array|string
     */
    protected array|string $uri = '/nacos/v2/ns/client/service/publisher/list';

    public function v2(string $serviceName): ClientServersPublishListInterface
    {
