...
use Nacosvel\NacosClient\Contracts\V1\Naming\UpdateInstanceInterface as V1;
use Nacosvel\NacosClient\Contracts\V2\Naming\UpdateInstanceInterface as V2;
use Nacosvel\NacosClient\NacosRequestResponse;

class UpdateInstanceRequest extends NacosRequestResponse implements V1, V2
{
    ...
    {
        return new class($serviceName, $ip, $port, 'v1') extends UpdateInstanceRequest implements V1, V2 {
    ...
    {
        return new class($serviceName, $ip, $port, 'v2') extends UpdateInstanceRequest implements V1, V2 {
            public function __construct(string $serviceName, string $ip, int $port, string $version = null)
            {
                parent::__construct($version);
                $this->setServiceName($serviceName)->setIp($ip)->setPort($port);
